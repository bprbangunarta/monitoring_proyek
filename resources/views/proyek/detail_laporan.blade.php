                ...
                <div class="row mb-2 ">
                    <div class="card col-lg-12">
                        <div class="d-flex justify-content-between card-header bg-dark text-white">
                            <h5 class="">LAPORAN KERJA</h5>
                            @can('Pengawas') @else
                            <button type="button" class="btn btn-info text-white ml-auto mr-2" data-toggle="modal"
                        ...
                        <div class="card-body">
                            <div class="card text-center">
                                <div class="card-header">
                                    <h4><strong>{{ $laporan->pekerjaan }}</strong></h4>
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title"><strong>DESKRIPSI:</strong></h5>
                                    <p class="card-text">{{ $laporan->detail }}</p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h5 class="card-title">Manajer : {{ $laporan->proyek->manager }}</h5>
                                    </div>
                            ...
                            <h5 class="card-header bg-dark text-white">INSIDEN</h5>
                                                        ...
                                                        @foreach ($insiden->image as $img)
                                                            <button type="button" data-toggle="modal"
                                                                ...
                                                                <img class="img-thumbnail w-40 h-40 ml-1"
                                                                    ...
                                                                    alt="Foto"></button>
                                                            <!-- Large modal -->
                                                            <div class="modal fade bd-edit{{ $img->id }}-modal-lg"
                            ...
                            <h5 class="card-header bg-dark text-white mt-2">SURVEI</h5>
                            @forelse ($proyek->survei as $survei)
                                @if (Str::startsWith($survei->created_at, substr($laporan->created_at, 0, 10)))
                                    <div class="card-body">
                                        <div class="card text-center">
                                            <div class="card-header">
                                                <h4><strong>{{ $survei->judul }}</strong></h4>
                                            </div>
                                            <div class="card-body">
                                                <h5 class="card-title"><strong>DESKRIPSI:</strong></h5>
                                                <p class="card-text">{{ $survei->detail }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-end mt-3">
                                            <div class="card text-center">
                                                <div class="card-body">
                                                    <h5 class="card-title">Pengawas : {{ $laporan->proyek->pengawas }}
                                                    </h5>
                                                </div>
                                                <div class="card-footer text-muted">
                                                    {{ $laporan->created_at }}
