<!-- Modal Laporan -->
<div class="modal fade bd-buat-survei-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                            placeholder="Judul Survei" name="judul" id="judul" value="{{ old('judul') }}"
                            required>
                    </div>
                                        ...
                                        <div class="custom-file" style="width: 100%; height: 100%;">
                                            <label
                                                ...
                                                <input id="img1" name="img1" type="file"
                                                    ...
                                                    onchange="viewImg('img1')" value="{{ old('img1') }}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="custom-file" style="width: 100%; height: 100%;">
                                            <label
                                                ...
                                                <input id="img2" name="img2" type="file"
                                                    class="pointer-events-none absolute inset-0 h-full w-full opacity-0"
                                                    onchange="viewImg('img2')" value="{{ old('img2') }}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="custom-file" style="width: 100%; height: 100%;">
                                            <label
                                                ...
                                                <input id="img3" name="img3" type="file"
                                                    class="pointer-events-none absolute inset-0 h-full w-full opacity-0"
                                                    onchange="viewImg('img3')" value="{{ old('img3') }}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="custom-file" style="width: 100%; height: 100%;">
                                            <label
                                                ...
                                                <input id="img4" name="img4" type="file"
                                                    class="pointer-events-none absolute inset-0 h-full w-full opacity-0"
                                                    onchange="viewImg('img4')" value="{{ old('img4') }}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="custom-file" style="width: 100%; height: 100%;">
                                            <label
                                                ...
                                                <input id="img5" name="img5" type="file"
                                                    class="pointer-events-none absolute inset-0 h-full w-full opacity-0"
                                                    onchange="viewImg('img5')" value="{{ old('img5') }}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
